...
public class Parametre_Controller implements Initializable {
    ...
    @FXML
    AnchorPane monAnchorImage;
    /*****************/
    static Circle  imagePersonnel ;
    /**********************************les images ************************************************/
    ...
    public static JFXButton ModifierButton;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        imagePersonnel.setStrokeWidth(3);
        imagePersonnel.setStrokeType(StrokeType.CENTERED);
        monAnchorImage.getChildren().add(imagePersonnel);
        ...
        ModifierButton =new JFXButton("Modifier");
        ModifierButton.setRipplerFill(Paint.valueOf("white"));
        ModifierButton.setStyle("-fx-font-size : 14 ; -fx-text-fill: white; -fx-border-radius: 10; -fx-background-radius: 7; -fx-background-color: #215DA7; -fx-font-family: Open sans; -fx-font-weight: bold;" );
        ModifierButton.setPrefSize(90,35);
        ModifierButton.setLayoutY(522);
        ModifierButton.setLayoutX(657);
