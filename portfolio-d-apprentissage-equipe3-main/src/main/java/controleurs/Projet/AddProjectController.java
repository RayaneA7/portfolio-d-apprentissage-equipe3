...
public class AddProjectController implements Initializable {
        ...
        AjouterBtn.setOnAction(e -> {
            ...
            try {
                output = new BufferedOutputStream(new FileOutputStream("DonnesUtilisateurs/"
                        +AccueilMediateur.studentFolder + "/"+(AccueilMediateur.utilisateur.listProjets.size()+1)+".png"));
    ...
    public void CreateProjet(ActionEvent event) throws IOException {
        ...
        /**Tempo Variable**/
        String tempType = "";
        //ArrayList<Competence> tempComp = new ArrayList<Competence>();
        ArrayList<String> tempDocs = new ArrayList<String>();

        Date date = new Date();
        date.setTime(123412341);
        Project projet = new Project(titleInput.getText(),tempType,projectComp,
                date,(AccueilMediateur.utilisateur.listProjets.size()+1)+".png",
                tempDocs,descriptionInput.getText());
